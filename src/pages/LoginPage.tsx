      ...
      <div className="w-full max-w-5xl z-10 flex flex-col md:flex-row overflow-hidden rounded-2xl shadow-2xl">
        ...
        <div className="md:w-1/2 relative bg-primary-600 dark:bg-primary-800 hidden md:block overflow-hidden">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center text-white z-20 p-12">
            ...
            >
              <span className="px-3 py-1.5 bg-white/20 rounded-full text-sm backdrop-blur-sm">Offline Support</span>
              <span className="px-3 py-1.5 bg-white/20 rounded-full text-sm backdrop-blur-sm">Rich Text Editor</span>
              <span className="px-3 py-1.5 bg-white/20 rounded-full text-sm backdrop-blur-sm">Mood Tracking</span>
            </motion.div>
          </div>
        ...
        >
          ...
          <h2 className="text-2xl font-semibold mb-6 text-gray-800 dark:text-gray-200">Welcome Back</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-8">Please sign in to continue your journaling journey.</p>
          ...
          <div className="mt-8 text-center">
            ...
            <Link to="/register" className="inline-block mt-2 text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 font-medium hover:underline transition-colors">
              Create an account
            </Link>
          </div>
